      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Advanced Intelligence, <br className="hidden sm:block" />Bhutanese Values
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Built with cutting-edge technology to understand, learn, and adapt to Bhutanese culture and needs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="BhutanAI learns from Bhutanese interactions, continuously improving its responses and actions to better serve local needs."
            index={0}
          />
          <FeatureCard
            ...
            description="Communicate using Dzongkha and local dialects. BhutanAI understands context and responds appropriately."
            index={1}
          />
          <FeatureCard
            ...
            description="Advanced legal framework integration provides accurate, compliant responses aligned with Bhutanese law."
            index={2}
          />
          <FeatureCard
            ...
            description="Advanced protocols and mapping technology allow BhutanAI to serve government functions with ease."
            index={3}
          />
          <FeatureCard
            ...
            description="Built-in protocols protect Bhutanese data and privacy, while ensuring secure local operation."
            index={4}
          />
          <FeatureCard
            ...
            description="From simple inquiries to complex government tasks, BhutanAI can assist with a wide range of services."
            index={5}
          />
        </div>
      </div>
